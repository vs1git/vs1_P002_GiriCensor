...
namespace Vs1Plugin
{
	public partial class GiriCensorDefaultDisable : MVRScript, VaMPluginI
	{
		MainBase main;

		public GiriCensorDefaultDisable()
		{
			main = new GiriCensorMain(this, false, "GiriCensorDefaultDisable");
		}
